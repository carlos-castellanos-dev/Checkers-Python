...
class Checker(TwoPlayerGame):
    ...
    def make_move(self, pos):
        """
        assign the pieces an index of position (pos) array to current player position.
        parameters
        -------
        ...
        ------
        """
        # Gets position of pieces from the table and assigns it to the current player position.
    ...
    def lose(self):
        ...
        """
        # Checks to see if piece is in other color territory. If not returns False.
    ...
    def is_over(self):
        ...
        """
        # Game is over if one player gets one of its pieces into other's territory or there are no more possible moves.
    ...
    def scoring(self):
       ...
       lose = -100
       """
        # Returns -100 if self.lose() returns True. Else returns 0.
